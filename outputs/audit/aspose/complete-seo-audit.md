...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Medium | missing_robots | technical-hugo-seo | THS-002 |  | SEO engineers, Hugo maintainers, Technical content platform owners | `/home/runner/work/blog-generator-agent/blog-generator-agent/outputs/_repos/aspose-blog` | No local robots.txt was found. Policy: technical-hugo-seo; rule: THS-002. | Add robots.txt or confirm Hugo generates one. | Low | Medium |
