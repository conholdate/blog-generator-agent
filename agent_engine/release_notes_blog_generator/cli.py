...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        ...
        description="Generate blog post drafts from product release notes.",
    )
    parser.add_argument("url", help="Release notes URL to process")
    parser.add_argument(
        "--output-dir",
        default=None,
    ...
    result = run(args.url, llm, settings)
